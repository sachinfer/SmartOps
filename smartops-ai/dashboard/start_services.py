...
def start_streamlit():
    ...
    try:
        ...
        process = subprocess.Popen([
            sys.executable, "-m", "streamlit", "run", "misi24x7_main.py",
...
def main():
    ...
    if not Path("event_api.py").exists() or not Path("misi24x7_main.py").exists():
        print("❌ Please run this script from the dashboard directory")
        print("   Expected files: event_api.py, misi24x7_main.py")
        sys.exit(1)
